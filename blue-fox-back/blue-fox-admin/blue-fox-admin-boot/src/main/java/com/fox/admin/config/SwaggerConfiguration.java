...
public class SwaggerConfiguration {
    ...
    public Docket restApi() {
        ...
        //密码模式
        String passwordTokenUrl="http://localhost:9999/blue-fox-auth/oauth/token";
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.fox.admin.controller"))
