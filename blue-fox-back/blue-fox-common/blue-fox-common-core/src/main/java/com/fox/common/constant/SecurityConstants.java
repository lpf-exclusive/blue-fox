package com.fox.common.constant;
...
public interface SecurityConstants {
    ...
    String LOGOUT_PATH = "/blue-fox-auth/oauth/logout";

    /**
     * 新增菜单路径,新增不存在的路由会导致系统无法访问，线上禁止新增菜单的操作
     */
    String SAVE_MENU_PATH = "/blue-fox-admin/api/v1/menus";
     ...
     */
    String APP_CLIENT_ID = "blue-fox-app";

    /**
     * 小程序端（微信小程序、....） 客户端ID
     */
    String WEAPP_CLIENT_ID = "blue-fox-weapp";
