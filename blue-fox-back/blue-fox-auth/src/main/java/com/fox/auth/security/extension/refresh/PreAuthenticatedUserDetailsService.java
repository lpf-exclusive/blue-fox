package com.fox.auth.security.extension.refresh;
...
import com.fox.common.enums.AuthenticationMethodEnum;
import com.fox.common.web.util.RequestUtils;
...
public class PreAuthenticatedUserDetailsService<T extends Authentication> implements AuthenticationUserDetailsService<T>, InitializingBean {
     ...
     *
     * @see com.fox.auth.security.config.AuthorizationServerConfig#tokenServices(AuthorizationServerEndpointsConfigurer)
     */
